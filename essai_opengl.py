...
class Polyedre:
    def __init__(self, # Constructeur de la classe Polyedre
        ...
        # Attention ici: la translation initiale est effectuée avant la rotation initiale
...
class Pyramide:
    def __init__(self):
        ...
        self.tetraedres = [
            ...
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [s1+s2 for s1,s2 in zip(sommets_tetraedre[0], sommets_tetraedre[1])]), 
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [s1+s2 for s1,s2 in zip(sommets_tetraedre[1], sommets_tetraedre[2])]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [s1+s2 for s1,s2 in zip(sommets_tetraedre[2], sommets_tetraedre[3])]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [s1+s2 for s1,s2 in zip(sommets_tetraedre[3], sommets_tetraedre[0])]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [s1+s2 for s1,s2 in zip(sommets_tetraedre[0], sommets_tetraedre[2])]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [s1+s2 for s1,s2 in zip(sommets_tetraedre[1], sommets_tetraedre[3])]),

            # Tétraèdres des extrémités (translations du tétrèdre de base par chacun des vecteurs sommets); envisager une boucle
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [2*s for s in sommets_tetraedre[0]]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [2*s for s in sommets_tetraedre[1]]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [2*s for s in sommets_tetraedre[2]]),
            Polyedre(sommets_tetraedre, aretes_tetraedre, faces_tetraedre, couleurs_aretes_tetraedre, couleurs_faces_tetraedre,
                     [2*s for s in sommets_tetraedre[3]])
        ...
        self.octaedres = [
            Polyedre(sommets_octaedre, aretes_octaedre, faces_octaedre, couleurs_aretes_octaedre, couleurs_faces_octaedre,
...
def gestion_clavier(event, pyramide, tab):
    global fleche_gauche, fleche_droite, fleche_haut, fleche_bas, touche_p, touche_m, ratio
...
def main(tab):
    ...
    pas_rotation_camera = 1.5 # ~vitesse de rotation de la caméra
    ...
    while True:
        ...
        for event in pygame.event.get():
            gestion_clavier(event, ma_pyramide, tab)
